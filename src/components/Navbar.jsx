      ...
      <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-4">
          <button
            ...
            className="flex items-center gap-2 text-gray-700 cursor-pointer hover:text-gray-900 font-medium px-4 py-2 "
          >
            <FaCartArrowDown /> ({totalItems})
          </button>

          <button className="flex items-center cursor-pointer gap-2 text-gray-700 hover:text-gray-900 font-medium px-4 py-2 ">
            Login
          </button>
