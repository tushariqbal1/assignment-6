        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center group cursor-pointer shadow-2xl p-5 rounded-md">
            <div className="mx-auto mb-6 w-20 h-20 bg-purple-100 rounded-2xl flex items-center justify-center text-4xl transition-transform group-hover:scale-110">
              <img src="/src/assets2/user.png" alt="" />
            </div>
          ...
          <div className="text-center group cursor-pointer shadow-2xl p-5 rounded-md">
            <div className="mx-auto mb-6 w-20 h-20 bg-purple-100 rounded-2xl flex items-center justify-center text-4xl transition-transform group-hover:scale-110"><img src="/src/assets2/package.png" alt="" /></div>
          ...
          <div className="text-center group cursor-pointer shadow-2xl p-5 rounded-md">
            <div className="mx-auto mb-6 w-20 h-20 bg-purple-100 rounded-2xl flex items-center justify-center text-4xl transition-transform group-hover:scale-110"><img src="/src/assets2/rocket.png" alt="" /></div>
